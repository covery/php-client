 ...
 *
 * Contains entity profile result data, received from Covery
 *
 * @package Covery\Client
 */
class EntityProfileResult implements \JsonSerializable
{
    /**
     * @var int
     */
    ...
    public function __construct($clientProfileId, $profileType, $createdAt)
    {
