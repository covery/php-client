...
namespace Covery\Client\EntityProfile;
...
class Builder
{
    ...
    /**
     * Returns builder for entity profile creation (POST).
     ...
     * @return Builder
     */
    public static function createEntityProfileEvent(
        $sequenceId,
        $userMerchantId = null,
        $accountStatus = null,
        $regDate = null,
    ...
    /**
     * Returns builder for entity profile update (PUT).
     ...
     * @return Builder
     */
    public static function updateEntityProfileEvent(
        $clientProfileId,
        $userMerchantId = null,
        $accountStatus = null,
        $regDate = null,
    ...
    /**
     * Provides entity profile fields to the packet.
     *
     * @return Builder
     */
    public function addProfileData(
        ...
        $this->assertString('company_name', $companyName, 255);
        $this->assertString('website_url', $websiteUrl, 255);
        $this->assertString('industry', $industry, 255);
    ...
    {
        if ($this->sendNulls) {
            return new EntityProfile($this->data);
        }
