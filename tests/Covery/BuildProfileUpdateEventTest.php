...
class BuildProfileUpdateEventTest extends TestCase
{
    ...
    public function testZeroValueForFloatWithAllowedZero()
    {
        ...
        $result = \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
            'profileUpdateSequenceId',
        ...
        self::assertSame(0.0, $result['one_operation_limit']);
        self::assertSame(0.0, $result['daily_limit']);
        self::assertSame(0.0, $result['weekly_limit']);
        self::assertSame(0.0, $result['monthly_limit']);
        self::assertSame(0.0, $result['annual_limit']);
        $validator->validate($result);
    }

    public function testEventExpectInvalidArgumentExceptionForNegativeOneOperationLimit()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("One Operation Limit cannot be negative");
        \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
            'profileUpdateSequenceId',
    ...
    public function testEventExpectInvalidArgumentExceptionForNegativeDailyLimit()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("Daily Limit cannot be negative");
        \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
    ...
    public function testEventExpectInvalidArgumentExceptionForNegativeWeeklyLimit()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("Weekly Limit cannot be negative");
        \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
    ...
    public function testEventExpectInvalidArgumentExceptionForNegativeMonthlyLimit()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("Monthly Limit cannot be negative");
        \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
    ...
    public function testEventExpectInvalidArgumentExceptionForNegativeAnnualLimit()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage("Annual Limit cannot be negative");
        \Covery\Client\Envelopes\Builder::profileUpdateEvent(
            'profileUpdateEventId',
            123456,
            'profileUpdateUserMerchantId',
